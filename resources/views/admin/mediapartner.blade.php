                  ...
                  <div class="px-2">
                    <div class="py-4">
                      <a
                        ...
                        class="t group relative flex justify-center rounded text-gray-500 hover:bg-gray-50 hover:text-gray-700 px-2 py-1.5 "
                      >
                        <svg
                    ...
                    <ul class="space-y-1 border-t border-gray-100 pt-4">
                      ...
                      <div class="py-4">
                          <a
                            ...
                            class="t group relative flex justify-center rounded text-gray-500 hover:bg-gray-50 hover:text-gray-700 jpx-2 py-1.5 "
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              class="size-5 opacity-75"
